...
- **AAGI PDF Short Report:** [AAGI PDF Short Report Demo](https://cbada-aus.github.io/AAGIQuarto/demos/template-pdf-short-report+short+report.pdf) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/demos/template-pdf-report.qmd))

- **AAGI PDF Report:** [AAGI PDF Report Demo](https://cbada-aus.github.io/AAGIQuarto/demos/template-pdf-report+report.pdf) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/demos/template-pdf-report.qmd))

- **AAGI Word Document Report:** [AAGI Word Document Demo](https://cbada-aus.github.io/AAGIQuarto/demos/template-docx-report.docx) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/demos/template-docx-report.qmd))
...
- **AAGI revealjs Presentation:** [AAGI revealjs Slide Demo](https://cbada-aus.github.io/AAGIQuarto/demos/template-revealjs.html#/title-slide) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/demos/template-revealjs.qmd)) (this is an `AAGIQuarto` exclusive)

- **AAGI PowerPoint Presentation:** [AAGI PPT Slide Demo](https://cbada-aus.github.io/AAGIQuarto/demos/template-pptx.pptx) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/demos/template-pptx.qmd))
...
By default, these templates use [{AAGIThemes}](https://cbada-aus.github.io/AAGIThemes/) and [{AAGIPalettes}](https://cbada-aus.github.io/AAGIPalettes/) for R graphical and tabular outputs.
