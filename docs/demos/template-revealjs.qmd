...
[CBADAQuarto](https://github.com/CBADA/CBADAQuarto) provides basic theming of HTML tables through CSS, for example, this is a markdown table.
...
For more advanced tables, we suggest pairing with the R package [{AAGIThemes}](https://github.com/AAGI-AUS/AAGIThemes) to provide AAGI themed tables using `theme_gt_cbada()`, that offers more flexibility in formatting.
...
# Thank You {background-image="_extensions/cbada/assets/title-slide-main.png" background-size="1050px auto" background-position="50% 85%"}
